...
```9981-air-default.uf2```: 

The keymap is as shown on the github page

```9981-air-hold400ms-output-sym.uf2```:

When you hold the key at layer0 for more than 400ms, the keyboard will type the corresponding symbol character. You can check the keymap at this [page](https://github.com/ZitaoTech/zmk-config-9981-air/blob/hold-400ms-output-sym-layer/config/p9981.keymap)
